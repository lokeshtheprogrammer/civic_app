...
const OfficerDashboard = () => {
    ...
    // In a future step, we can filter issues to show unassigned or assigned to the current officer.
        ...
        <>
            ...
            <section className="flex-grow">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">
                    Issue Queue ({filteredIssues.length} found)
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredIssues.length > 0 ? (
                        ...
                        <p className="text-gray-500 col-span-full text-center py-10">No issues in the queue.</p>
                    )}
                </div>
            </section>
        </>
